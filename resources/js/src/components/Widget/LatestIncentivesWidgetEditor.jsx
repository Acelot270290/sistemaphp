...
function LatestIncentivesWidgetEditor( { color, setColor, name, setName, rankingPeriod, setRankingPeriod, rankingDirection, setRankingDirection, numberOfUsers, setNumberOfUsers } ) {
  return (
    <div>
      <fieldset style={styles.fieldset}>
        <legend style={styles.legend}>Customize ultimos Incentivos</legend>
...
export default LatestIncentivesWidgetEditor;
